...
// indirectly are no longer valid.
TOML_EXTERN void toml_free(toml_table_t *tab);

// Timestamp types. The year, month, day, hour, minute, second, z fields may be
// NULL if they are not relevant. e.g. In a DATE type, the hour, minute, second
// and z fields will be NULLs.
...
// For array kind 'v'alue, return the type of values i:int, d:double, b:bool,
// s:string, t:time, D:date, T:timestamp, 'm'ixed 0 if unknown
